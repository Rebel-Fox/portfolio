...
export default function About() {
  return (
    <div className="flex-1 flex flex-col  sm:flex-row  ">
      <h1 className=" w-1/2 self-center text-center font-extrabold font-serif text-5xl md:text-7xl ">
        <span className="relative after:content-[''] after:absolute after:w-full after:h-4 after:bottom-1 after:left-6 after:bg-red-600 after:-z-10">
          Front-End
        </span>
        <br />
        <span className="relative after:content-[''] after:absolute after:w-full after:h-4 after:bottom-1 after:left-6 after:bg-red-600 after:-z-10">
      ...
      <div className=" relative w-1/2 px-2 text-center   bg-[url('/assets/self-img.jpg')] bg bg-cover bg-no-repeat">
        ...
        <p className="relative  z-10 font-semibold text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-3xl font-serif backdrop-blur-md max-w-md rounded-lg px-2 py-4">
          Hi, I'm
          <span className="text-red-600 bg-neutral-100 px-1">Vineet Kumar</span>
          , an aspiring Front-End Developer currently in my 2nd year of B.Tech
          CSE at
          <span className="text-red-600 bg-neutral-100 px-1">
            IIT Bhubaneswar.
          </span>
        </p>
      </div>
